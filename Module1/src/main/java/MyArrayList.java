/* Реализовать ArrayList, LinkedList, написать на методы JavaDoc,
 нельзя использовать методы Collection. Методы — add, remove, get, set, subList, size*/
...
public class MyArrayList<T> {
   ...
   */
    ...
    */
    ...
    /**
     *  Изменяет (устанавливает; от слова set) значение поля.
     */
